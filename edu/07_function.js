...
// 함수 선언식
// parameter : 함수 정의에서 전달받은 argument를 지정하는 변수인(소괄호 안) a와 b
function fnc1(a, b){
  let sum = a + b;
...
// argument(인수) : 함수 호출에서 전달되는 값임(소괄호 안) 1과 2
let result = fnc1(1, 2);
...
const fnc4 = (a, b) => a + b; // 한줄일때 중괄호 retrun 생략가능
const fnc5 = a => `ttt ${a}`; // parameter가 1개일때 소괄호도 생략가능
const fnc6 = () => 'test'; // parameter 없을시 소괄호 생략X
